...
@Component({
  selector: 'app-manager-view-book',
  imports: [CommonModule, RouterModule, UserComponent, UpdateBookComponent, FormsModule,RouterOutlet],
  templateUrl: './manager-view-book.component.html',
  styleUrl: './manager-view-book.component.css'
})
export class ManagerViewBookComponent implements OnInit{
  books: any[] = [];
...
function autoTable(doc: any, arg1: { head: string[][]; body: any[][]; startY: number; theme: string; headStyles: { fillColor: number[]; }; }) {
